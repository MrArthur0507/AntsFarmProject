    ...
    public class AStarPathFinder : IPathFinder
    {
        public List<Point> FindPath(Point start, Point end, IBoard b)
        {
            ...
            while (openList.Count > 0)
            {
                ...
                foreach (var neighbor in GetNeighbors(current.Position, b))
                {
                    ...
                    PathFindableEntity entity = (PathFindableEntity)b.GetBoard()[neighbor.Position.X, neighbor.Position.Y];
        ...
        private IEnumerable<Node> GetNeighbors(Point position, IBoard b)
        {
            ...
            foreach (var dir in directions)
            {
                ...
                if (neighborPos.X >= 0 && neighborPos.Y >= 0 && neighborPos.X < b.GetBoard().GetLength(0) && neighborPos.Y < b.GetBoard().GetLength(1))
